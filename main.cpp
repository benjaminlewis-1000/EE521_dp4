...
//    for(int i = 0; i < uniqueSubset.size(); i++){ 
    ...
    //   cout << "Pruned: " << pruned[ uniqueSubsets[i] ].oldSubsetNumber 
     //      << " uniqueSubset(" << uniqueSubsets[i] << "): " << uniqueSubsetNames[i] << endl;
  ...
  /*  cout << "Pruned subsets" << endl;
    process_solution(subsets_decimal, testPS);*/
